...
import (
	...
	"github.com/yanko-xy/user/domain/repository"
	"path/filepath" 
    
	//"github.com/afex/hystrix-go/hystrix"
	"github.com/asim/go-micro/plugins/registry/consul/v3"
	service2 "github.com/yanko-xy/user/domain/service"
	...
	"github.com/yanko-xy/user/handler"
	//hystrix2 "github.com/yanko-xy/user/plugin/hystrix"
	"strconv"
	"k8s.io/client-go/kubernetes"
	"k8s.io/client-go/tools/clientcmd"
	"k8s.io/client-go/util/homedir"
	user "github.com/yanko-xy/user/proto/user"
